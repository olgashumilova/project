...
const SearchByPlaystation: React.FunctionComponent = () => {
  ...
  async function fetchData() {
    await axios.get(`http://localhost:3001/playstationgames/${text}`).then((response) => {
      if (text.length != 0) {
...
export default SearchByPlaystation